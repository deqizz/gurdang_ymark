<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
                <?php
                    foreach ($supplier_local as $key => $value) {
                ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group required">
                  <label class="col-sm-3 control-label">Asal Kota</label>
                  <div class="col-sm-8">
                  <input type="text" class="form-control" maxlength="50" required name="asal_kota" placeholder="Asal Kotar">
                  </div>
                </div>
          ...
          <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group required">
                  <label class="col-sm-3 control-label">Asal Kota</label>
                  <div class="col-sm-8">
                  <input type="text" class="form-control" maxlength="50" required name="asal_kota" placeholder="Asal Kota">
                  </div>
                </div>                            
          <div class="modal-footer">
            <button type="button" class="btn btn-default close-modal">Close</button>
